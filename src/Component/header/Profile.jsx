...
const Profile = ({ drawer }) => {

  const { username, setUserName } = useContextData();
  ...
  return (
    <>
      ...
      >
        ...
        <IoIosArrowDown style={{ cursor: "pointer", fontSize: "15px" }} />
      </Box>

      <Menu anchorEl={open} open={Boolean(open)} onClick={handleClose} >
